...
export default function UpdateMedia() {
  ...
  const updateMutation = useMutation({
    ...
    onError: (err) => {
      alert(
        "Failed to update media: " + (err.response?.data?.error || err.message),
      );
    },
  });
  ...
  const currentMediaUrl = getMediaUrl(media);
  const currentThumbnailUrl = getThumbnailUrl(media);
      ...
      <div className={styles.card}>
            ...
            <div className={styles.previewWrapper}>
              {isImage ? (
                <img
                  ...
                  alt={media.filename}
                  onClick={() => window.open(currentMediaUrl, "_blank")}
        ...
        <div className={styles.formSection}>
          <div className={styles.formGroup}>
            <label className={styles.label}>Filename / Description</label>
            <p className={styles.helpText}>
              Update the display name of the file.
            </p>
            <input
              type="text"
          ...
          <div className={styles.formGroup}>
            ...
            <p className={styles.helpText}>
              Upload a new file to replace the existing content.
            </p>
        ...
        <div className={styles.footer}>
          ...
          <Button
            ...
            disabled={
              updateMutation.isPending || (filename === null && !selectedFile)
            }
          >
